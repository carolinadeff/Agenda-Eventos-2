...
function paginaCriacaoUsuario(req, res) {
    return res.render('novoUsuario.html', {mensagem: ''})
}
...
function criacaoUsuario(req, res) {
    ...
    if(!erros.isEmpty()) {
        return res.render('novoUsuario.html', {mensagem: msgErro, })
    }
    ...
    usuarioDao.buscaTodos()
        ...
        .then(resultado => {
            if (resultado) {
                return res.render('novoUsuario.html', {mensagem: 'O email de usuário já está cadastrado.', })
            }else{
                usuarioDao.criaUsuario(req.body)
                    .then(res.render('novoUsuario.html', {mensagem: 'Usuário criado com sucesso!'}))
                    .catch(erro => res.render('novoUsuario.html', {mensagem: erro}))
            }
        })
